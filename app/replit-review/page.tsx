      ...
      <main className="min-h-screen bg-black text-white px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-10">
            Replit is a powerful AI assistant for writing, coding, research,
          ...
          <section className="mb-14">
            <h2 className="text-3xl font-bold mb-5">What is Replit AI?</h2>
            <p className="text-gray-300 leading-8">
              Replit is an AI assistant created by Replit. It is especially
          ...
          <section className="mb-14">
            <h2 className="text-3xl font-bold mb-5">Is Replit Worth It?</h2>
            <p className="text-gray-300 leading-8">
              Yes. Replit is one of the best AI tools for creators, students,
