export default function LovableReviewPage() {
    return (
      <main className="min-h-screen bg-black text-white px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-300 mb-10">
            Lovable is a powerful AI assistant for writing, coding, research,
          ...
          <section className="mb-14">
            <h2 className="text-3xl font-bold mb-5">What is Lovable AI?</h2>
            <p className="text-gray-300 leading-8">
              Lovable is an AI assistant created by Lovable. It is especially
          ...
          <section className="mb-14">
            <h2 className="text-3xl font-bold mb-5">Is Lovable Worth It?</h2>
            <p className="text-gray-300 leading-8">
              Yes. Lovable is one of the best AI tools for creators, students,
          ...
          >
            Visit Lovable Official Website
          </a>
        </div>
      </main>
    );
